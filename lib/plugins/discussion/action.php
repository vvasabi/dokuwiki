    ...
    if ($act == 'add'){
      ...
      ?>
          ...
          <div class="comment_name">
            <label for="discussion__comment_name">
          ...
          <div class="comment_mail">
            <label for="discussion__comment_mail">
      ...
      ?>
          <div class="comment_url">
            <label for="discussion__comment_url">
              <span><?php echo $this->getLang('url') ?>:</span>
              <input class="edit" name="url" id="discussion__comment_url" size="50" tabindex="3" value="<?php echo hsc($_REQUEST['url'])?>" />
            </label>
          </div>
      <?php
      }
      ...
      ?>
          <div class="comment_address">
            <label for="discussion__comment_address">
